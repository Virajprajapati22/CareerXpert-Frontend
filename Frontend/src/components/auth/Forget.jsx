...
const Forget = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('http://localhost:5001/api/v1/user/forgot-password', { email });
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="w-full mx-4 max-w-md bg-white p-8 rounded-lg border border-gray-400">
                ...
                <form   onSubmit={handleSubmit}>
                    <div className="mb-4">
                    <Input lablename="Email" name="Email" value={email} type="email" className="w-3/4 mx-auto" onChange={(e)=>setEmail(e.target.value)} />
                    </div>
